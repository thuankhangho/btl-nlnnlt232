...
class ZCodeListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ZCodeParser#boollit.
    def enterBoollit(self, ctx:ZCodeParser.BoollitContext):
        pass

    # Exit a parse tree produced by ZCodeParser#boollit.
    def exitBoollit(self, ctx:ZCodeParser.BoollitContext):
        pass

...
class CheckSuite(unittest.TestCase):
    ...
    #         func main() return
    #     """
    #     expect = "Type Mismatch In Statement: VarDecl(Id(x), StringType, None, BinaryOp(+, NumLit(2.0), CallExpr(Id(foo), [])))"
    ...
    #     end
    #     """
    #     expect = "Type Cannot Be Inferred: VarDecl(Id(b), None, dynamic, None)"
